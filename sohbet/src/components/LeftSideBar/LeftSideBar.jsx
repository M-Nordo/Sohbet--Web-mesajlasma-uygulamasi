...
import { collection, query, where, getDocs, getDoc, doc, setDoc, serverTimestamp, updateDoc, arrayUnion } from 'firebase/firestore';
    ...
    <div className={`ls ${chatVisible ? "hidden" : ""}`}>
      <div className="ls-top">
        ...
        <div className="ls-search">
          ...
          <input onChange={inputHandler} type="text" placeholder='Ara' />
        </div>
      </div>
