...
const ProfileUpdate = () => {
    ...
    const profileUpdate = async (event) => {
        ...
        try {
            if (!prevImage && !image) {
                toast.error("Profil fotoğrafı ekleyiniz.");
                return;
            }
            ...
            <div className="profile-container">
                <form onSubmit={profileUpdate}>
                    ...
                    <label htmlFor="avatar">
                        ...
                        Profil Fotoğrafınızı Yükleyiniz
                    </label>
                    <input onChange={(e) => setName(e.target.value)} value={name} type="text" placeholder='Adınız' required />
                    <textarea onChange={(e) => setBio(e.target.value)} value={bio} placeholder='Hakkınızda...' required></textarea>
